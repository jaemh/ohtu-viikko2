...
public class Stepdefs {
    ...
    @Given("^username_and_password_validates$")
    public void username_and_password_validates() {
        givenUsername= "laura";
        givenPassword= "lauralaura1";
    }

    @When("^username \"([^\"]*)\" and password \"([^\"]*)\" are entered$")
    public void username_and_password_entered(String username, String password) throws Throwable {
      inputLines.add(username);
      inputLines.add(password);
